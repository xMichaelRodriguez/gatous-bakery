...
export const NavScreen = () => {
  return (
    <>
      <Nav className='' defaultActiveKey='/#' as='ul'>
        <Nav.Item as='li'>
          <Nav.Link href='/#'>
        ...
        >
          <Nav.Item as='li' className='mx-5'>
            <Nav.Link
              className='text-success'
              eventKey='https://api.whatsapp.com/send?phone=+50372745936'
              href='https://api.whatsapp.com/send?phone=+50372745936'
              target='_blank'
            >
              <BsWhatsapp />
            </Nav.Link>
